 ...
 *
 * @param enabled 오픈 이벤트 활성 여부. false 면 전 참여가 환급 비대상이다.
 * @param submitWindowDays 신청 마감 산정용 일수. 마감 기준 시점(현재 임시로 배송 완료 시각 — {@link ShippingFeePaybackPolicy}
 *     참고)부터 이 일수가 지나면 신청이 만료(EXPIRED)된다.
 */
@Validated
